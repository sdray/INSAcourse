...
rmarkdown::render(here::here("practical/session7","session7.Rmd"))
rmarkdown::render(here::here("practical/session7","session7.Rmd"),
                  params = list(correction = TRUE), output_file = "session7-corrected")
...
pagedown::chrome_print(here::here("practical/session7","session7.html"))
pagedown::chrome_print(here::here("practical/session7","session7-corrected.html"))

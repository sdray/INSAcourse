...
6. Look at the percentage of variation explained by the between-class analysis (stored in the object). Perform permutational multivariate analysis of variance with the function `vegan::adonis2` using the Euclidean distances. Compare
...
## Answer 5
bca1 <- bca(pca.meau, meaudret$design$season, scannf = FALSE)
...
## Answer 6
vegan::adonis2(dist(meaudret$spe)~meaudret$design$season)
randtest(bca1)
```
